    ...
    <div className="no-cursor relative min-h-screen w-full overflow-hidden bg-black">
      ...
      <header className="flex items-center justify-between px-4 py-2">
        ...
        {user ? (
          ...
          <Link
            href="/auth"
            className="no-cursor h-[48px] group relative flex items-center gap-2 overflow-hidden rounded-lg border-2 border-white bg-black/50 px-8 py-2 text-white transition-all hover:border-gray-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]"
          >
      ...
      <div className="relative z-10 flex h-screen flex-col items-center justify-center">
        ...
        Let's bring attention to the inconsistency of the UGA Buses. <br />
        On top of that let's have a little fun with their inconsistency! <br />
        </p>
