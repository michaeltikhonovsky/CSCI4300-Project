...
const ROUTE_SEQUENCES = {
  ...
  "Health Sciences": [
    ...
    "Springdale Street",
    "Oakland Ave (to Five Points)",
    "Lumpkin St @ Rutherford St (to campus)",
    "Snelling Dining Commons",
    "Physics (to Tate)",
    "Memorial Hall",
    "Gilbert Hall",
  ...
  "Riverbend Connector": [
    ...
    "Club Sports",
    "Botanical Gardens",
    "Lakeside Dr at Bldg A 2nd Stop IB",
    "Lakeside Dr at Bldg L IB",
    "Lakeside Dr at Bldg J IB",
    "Lakeside Dr at Bldg I IB",
    "UGA Campus Transit",
    "CCRC",
    "UGA Automotive Center Inbound",
    "East Campus Village",
    "Aderhold Hall (to Plant Science)",
    "Plant Sciences",
    "Coverdell",
    "Driftmier Engineering Center (to College Station)",
    "Building F",
    "UGA Automotive Center Outbound",
  ],
...
export async function getRandomBusToStopETA(
  ...
  try {
    ...
    return {
      duration:
        route.duration_in_traffic?.text || route.duration?.text || "Unknown",
