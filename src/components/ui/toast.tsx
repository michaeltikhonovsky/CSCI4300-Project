...
const toastVariants = cva(
  "group pointer-events-auto font-mono relative flex w-full items-center justify-between space-x-2 overflow-hidden rounded-none border p-4 pr-6 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        default: "border border-2 border-white bg-background text-white",
        success: "border border-2 border-white bg-black text-white",
        destructive: "destructive group border-white bg-red-800 text-white",
      },
    },
    defaultVariants: {
      variant: "default",
